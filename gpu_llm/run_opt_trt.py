...
def run():
    ...
    runner_kwargs = {
        # 'engine_dir': "./opt/6.7B/trt_engines/fp16/1-gpu/",
        # 'engine_dir': "./examples/opt/opt/125M/trt_engines/fp16/2/",
        # 'engine_dir': "./opt/125M/trt_engines/fp16/2/",
        'engine_dir': "/home/jinseop/TensorRT-LLM/examples/opt/opt/125M/trt_engines/fp16/2/",
    ...
    print()
    print("Input length: %d / output length: %d" % (len(input_tokens["input_ids"][0]), len(output_tokens[0])))
