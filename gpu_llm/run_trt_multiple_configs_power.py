...
def run():
    ...
    if args.model == "facebook/opt-6.7b" and args.n_gpus == 1:
        engine_dir = "opt/6.7B/trt_engines/bf16/1-gpu_input_100/"
        ...
        engine_dir = "llama/8B/trt_engines/bf16/1-gpu_input_100/"
    ...
    # input_output_lengths = [(50, 450), (100, 400), (200, 300), (300, 200), (400, 100), (450, 50)]
    # input_output_lengths = [(100, 25), (100, 50), (100, 100), (100, 200), (100, 400)]
    # input_output_lengths = [(100, 1), (19, 1), (161, 1), (756, 1)]
    input_output_lengths = [(100, 25)]
